        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            {C.contact.googleMapsEmbedUrl ? (
              <iframe title={`${C.business.name} — Google Maps`} src={C.contact.googleMapsEmbedUrl} width="100%" height="100%" sandbox="allow-scripts allow-popups allow-presentation" style={{border:0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
            ) : (
